...
class HistoryViewModel @Inject constructor(
    ...
    private var totalPages = 1 // Khởi tạo là 1 để lần đầu vẫn chạy được
    ...
    fun loadNextPage() {
        if (_isLoading.value || (currentPage > 1 && currentPage > totalPages)) return
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (response.isSuccessful && body != null && body.success) {
                    ...
                    val newPictures = body.data
                    val combinedList = (_pictures.value + newPictures).distinctBy { it.id }

                    _pictures.value = combinedList
